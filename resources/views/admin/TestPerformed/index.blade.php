                ...
                <tbody>
                    ...
                    @foreach($c as $key => $even)
                        ...
                        <tr>
                            ...
                            <td>
                            @if ($even->state =='Progressing')
                            <button class="btn btn-xs btn-info">{{ $even->state ?? '' }}</button>
                               @elseif ($even->state =='Varified')
                               <button class="btn btn-xs btn-primary">{{ $even->state ?? '' }}</button>
                          
                               @elseif ($even->state =='Not Recived')
                               <button class="btn btn-xs  btn-warning">{{ $even->state ?? '' }}</button>
                               @elseif ($even->state =='Cancelled')
                               <button class="btn btn-xs btn-danger">{{ $even->state ?? '' }}</button>
                             @else
